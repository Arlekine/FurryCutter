...
namespace UnitySpriteCutter.Cutters {
    ...
    {
        public static Mesh CreateMeshFromShape(Mesh startMesh, Vector2[] shape)
        {
			return GenerateHalfMeshFrom(startMesh, shape);
		}

        public static Vector2[] ConvertVerticesToShape( Vector3[] vertices ) {
